    ...
    return (
        <div className={styles.wrapper}>
            ...
            <Container className={styles.container}>
                <Navbar.Brand href='/' className={`${styles.logo} ${styles.logo2}`}></Navbar.Brand>
                <Navbar.Toggle aria-controls='basic-navbar-nav' />
          <Navbar.Collapse id='basic-navbar-nav' className={styles.menu_nav0}>
                <Nav className='me-auto'>
                    <Nav.Link href='/' className={styles.menu_nav}>Главная</Nav.Link>
                    ...
                    <Nav.Link href='/' className={styles.menu_nav}>Ответы на обращения</Nav.Link>
